...
class material{
    public:
        ...
        __device__ virtual bool scatter(hitBuffer* hits, rayBuffer* rays, int idx, color& attenuation, curandState* state) const {
            return false;
        }
};
...
class lambertian : public material {
    public:
        ...
        __device__ bool scatter(hitBuffer* hits, rayBuffer* rays, int idx, color& attenuation, curandState* state) const override {
...
public:
    ...
    __device__ bool scatter(hitBuffer* hit_buf, rayBuffer* r_buf, int h_idx,
                            color& attenuation, curandState* state) const override {
