...
__device__ __host__ inline interval empty_interval()    { return interval(+infinity, -infinity); }
__device__ __host__ inline interval universe_interval() { return interval(-infinity, +infinity); }
#endif