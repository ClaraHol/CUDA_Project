...
__global__ void init_rand_pixel(curandState* states, int width, int height, unsigned long seed) {
...
__global__ void init_rand_ray(int num_rays, unsigned long seed, curandState* states) {
