...
class vec3 {
    ...
    public:
        ...
        __device__ static vec3 random(curandStatePhilox4_32_10_t* state){
        ...
        __device__ static vec3 random(float min, float max, curandStatePhilox4_32_10_t* state){
...
__device__ inline vec3 random_on_hemisphere(const vec3& normal, curandStatePhilox4_32_10_t* state){
...
__device__ inline vec3 random_on_unit_disk(curandStatePhilox4_32_10_t* state){
    /* 
