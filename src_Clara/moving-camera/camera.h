...
class camera {
    public:
        ...
        float image_height = 1200;          // Image height in pixels
        ...
        __host__ void move_to_device(camera* d_cam) {
        ...
        __device__ color ray_color(const ray& r, int depth, hittable** objects,  bvh_array* bvh, curandState* state) const {
    ...
    // Private camera parameters
        ...
        //int samples_per_pixel;      // Number of rays per pixel
